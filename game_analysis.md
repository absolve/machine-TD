...
| 敌人类型 | 特点 | 脚本文件 |
|---------|------|---------|
| 迷你坦克 (miniTank) | 基础敌人，沿路径移动 | [mini_tank.gd](file:///e:/machine-TD/machine-td/script/mini_tank.gd) |
| 中型坦克 (mediumTank) | 具备雷达和炮塔旋转，攻击塔方法已接入框架 | [mediumTank.gd](file:///e:/machine-TD/machine-td/script/mediumTank.gd) |
| 重型坦克 (heavyTank) | 高血量敌人 | [heavyTank.gd](file:///e:/machine-TD/machine-td/script/heavyTank.gd) |
| 飞行单位基类 (Aircraft) | 新增类，无人机继承此类 | [aircraft.gd](file:///e:/machine-TD/machine-td/script/aircraft.gd) |
...
- aircraft.gd 补全：独立飞行路径（非 PathFollow2D）/ 受伤 / 奖励 / 普通塔不可见（只有无人机/激光可命中）
...
**文档版本**：v2.0  
**更新日期**：2026-08-19  
**项目状态**：开发中（7种塔/关卡选择/设置面板/多语言骨架已就绪，待补齐后端逻辑与升级系统）

---

*本文档为 Machine-TD 塔防游戏的项目分析报告 v2，涵盖 v1→v2 期间新增的 4 种塔、关卡系统、设置系统及所有新增 TODO 项。*
